...
const Navbar = () => {
  ...
  return (
    // <header className="min-h-[80px] top-0 left-0 w-full  z-50 bg-[#050B18]">
    //   <div className=" lg:mx-auto lg:w-auto w-full p-4 ">
    //     <div className="flex items-center gap-4 border md:h-[140px] py-4 ">
    ...
    //       <div className="flex gap-8 border border-yellow-500 ">
    //         {/* Nav Links */}
 ...
 <div className="w-full px-4 lg:px-8">
    ...
    <div className="flex items-center justify-between md:h-[120px] py-4">
     ...
     <a href="/">
      ...
      <div className="hidden lg:flex items-center gap-10">
        ...
        <ul className="flex items-center gap-6 xl:gap-8 font-medium text-white">
          ...
          {/* Ecommerce */}
          <li className="relative group cursor-pointer">
            <span className="hover:text-[#FF7A00] transition">
              Ecommerce
            </span>
          ...
          <li>
            <Link to="/quick-market" className="hover:text-[#FF7A00]">
              QuickMarket
            </Link>
          </li>
          ...
          <li className="relative group cursor-pointer">
            ...
            <ul className="absolute z-50 left-0 top-full mt-0 shadow-sm shadow-[#FF7A00] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200 bg-[#050B18] rounded-md p-4 w-48">
              <li className="py-1 hover:text-[#FF7A00]">
                <Link to="/web/app-design">App Design</Link>
              </li>
              <li className="py-1 hover:text-[#FF7A00]">
          ...
          <li>
            <Link to="/clients" className="hover:text-[#FF7A00]">
              Our Clients
            </Link>
          </li>
        ...
        {/* CTA */}
        <Button>
          <a href="https://wa.me/917303800109?text=Hi%20I%20want%20to%20know%20about%20your%20services">
            Get Consultant 🚀
          </a>
        </Button>
      </div>
